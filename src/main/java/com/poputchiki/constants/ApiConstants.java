...
public interface ApiConstants {
    ...
    String[] securedPaths = new String[]{API_AUTH_TOKEN_PATH,API_AUTH_LOGOUT_PATH,API_TRIPS_MINE_PATH,API_USER_PATH,API_JOIN_TRIP_BY_ID_PATH,API_NEW_TRIP_PATH,API_DELETE_TRIP_BY_ID_PATH, API_POPUTCHIKI_PATH};
